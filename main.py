...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, type):
        ...
        if type == 'fly':
            fly_1 = pygame.image.load('graphics/New folder/fly1.png').convert_alpha()
            fly_2 = pygame.image.load('graphics/New folder/fly2.png').convert_alpha()
...
pygame.display.set_caption('Meek Runner')
...
game_name = test_font.render('Meek Runner', False, (111, 196, 169))
